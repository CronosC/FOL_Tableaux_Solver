%--------------------------------------------------------------------------
% File     : SYN654-1 : TPTP v8.1.2. Released v2.5.0.
% Domain   : Syntactic
...
% Rating   : 0.14 v8.1.0, 0.25 v7.4.0, 0.17 v7.3.0, 0.25 v6.2.0, 0.17 v6.1.0, 0.29 v6.0.0, 0.33 v5.5.0, 0.31 v5.4.0, 0.33 v5.3.0, 0.35 v5.2.0, 0.46 v5.1.0, 0.38 v5.0.0, 0.40 v4.0.1, 0.57 v3.7.0, 0.43 v3.4.0, 0.20 v3.3.0, 0.33 v3.1.0, 0.17 v2.7.0, 0.00 v2.5.0
